...
class AlohaEthereumService:
    async def GetNullAddress(self, request: NullAddressRequest, context: ServiceContext) -> NullAddressResponse:
        """
    ...
    async def ChecksumAddress(self, request: NullAddressRequest, context: ServiceContext) -> NullAddressResponse:
        """
